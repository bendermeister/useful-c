...
__attribute__((used)) static void *global_alloc(void *ctx, usize num_bytes,
                                                Error **error) {
  UNUSED(ctx);
...
global_realloc(void *ctx, void *chunk, usize num_bytes, Error **error) {
  UNUSED(ctx);
...
__attribute__((used)) static void global_free(void *ctx, void *chunk,
                                              Error **error) {
  UNUSED(ctx);
  UNUSED(error);
